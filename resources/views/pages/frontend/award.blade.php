                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hm-enty-head text-center text-uppercase">
                            ...
                            <p>Awards of Major Steel Building Technology Ltd</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/award/award-1.jpg" />
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/award/award-2.jpg" />
                                </div>
                            </div>
                            <div class="hm-gallery-grid-dsc">
                                <h5>Title 2023</h5>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/award/award-3.jpg" />
                                </div>
                            </div>
                            <div class="hm-gallery-grid-dsc">
                                <h5>Title 2023</h5>
