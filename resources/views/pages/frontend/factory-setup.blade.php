                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hm-enty-head text-center text-uppercase">
                            <h2><span>Factory </span> Setup</h2>
                            <p>
                                Factory Setup Major Steel Building Technology
                                Ltd
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="inner_page">
                            <p>
                                <strong
                                    >We provide to our client one stop solution
                                    from starting to final delivery. From our
                                    end we make drawing, structural steel
                                    design, pre-fabrication, and painting,
                                    finishing and erection as well as final
                                    installation</strong
                                >
                            </p>
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-10 col-lg-8">
                                    <div class="fs-image text-center">
                                        <img
                                            class="img-fluid"
                                            src="assets/images/one_step.jpg"
                                            alt="" />
                                    </div>
                                </div>
                            </div>
