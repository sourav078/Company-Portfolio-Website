...
<html>
    ...
    <body>
        ...
        <!-- Page Header End -->
        <!-- Vision Main Start-->
        <section class="about vision mb-3 mb-lg-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="hm-enty-head text-center text-uppercase">
                            ...
                            <p>
                                History About Major Steel Building Technology
                                Ltd
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="inner_page">
                            <p>
                                <strong>Major Steel</strong> was established in
                                2012, as
                                <strong
                                    >Major Steel Building Technology Ltd</strong
                                >
                                by the founder of the company Mr. A.K.M Altaf
                                Hossain. It has own pre-engineered steel
                                buildings manufacturing plant that spans over
                                40,000 square feet on the outskirts of Dhaka, at
                                Quantam Industrial Park, Shalna, Gazipur
                                (approximately 15 Kilometers from Hazrat
                                Shahjalal International Airport, Dhaka). By
                                Partnering with QG, the clients are assured of
                                quality product. QG is accredited by the ORI
                                (ISO 9001:2008).
                            </p>
                            <p>
                                We deal with various types of construction
                                works. But specially we are one of the leading
                                pre-fabricated manufacturer in Bangladesh. The
                                institution is highly specialized to give ONE
                                STOP solution for pre-fabricated/engineered
                                steel structures, buildings and
                                multi-dimensional facilities, all under one
                                roof. Many companies talk about relationships,
                                but when you join forces with QG, you are
                                receiving security, accuracy and efficiency with
                                a personal touch. QG has a workforce of
                                approximately 943 employees, as engineers,
                                operators, welders, fabricators, site
                                supervisors and managers. It owns excellent
                                range of modern construction and transportation
                                equipment and machinery. All of our machineries
                                are world class which meets highest standards of
                                quality and efficiency.
                            </p>
                            <p>
                                We have undertaken numerous around Bangladesh,
                                erecting warehouse, sheds, electric control
                                rooms, industrial complexes, storage facilities,
                                power plants and site offices for large and
                                renowned organizations such as Beximco Group,
                                Square Group, BSRM Steel Limited, Akij Group,
                                Orin Group, Sinha Group, Shanta Group, DBL
                                Group, DIU, PRAN RFL Group, Youngone Group etc.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="footer-btm-wrp clearfix">
                                <div class="footer-btm-lft">
                                    <p>
                                        Copyright &copy; 2022 Major Steel Bd.
                                        All Rights Reserved.
                                    </p>
                                </div>
