                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hm-enty-head text-center text-uppercase">
                            <h2><span>Power </span> Plants</h2>
                            <p>
                                Power Plant of Major Steel Building Technology
                                Ltd
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/power-plant/power-plant-1.jpg" />
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/power-plant/power-plant-2.jpg" />
                                </div>
                            </div>
                            <div class="hm-gallery-grid-dsc">
                                <h5>Title 2023</h5>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/power-plant/power-plant-3.jpg" />
                                </div>
                            </div>
                            <div class="hm-gallery-grid-dsc">
                                <h5>Title 2023</h5>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/power-plant/power-plant-4.jpg" />
                                </div>
                            </div>
                            <div class="hm-gallery-grid-dsc">
                                <h5>Title 2023</h5>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/power-plant/power-plant-5.jpg" />
                                </div>
                            </div>
                            <div class="hm-gallery-grid-dsc">
                                <h5>Title 2023</h5>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="hm-gallery-grid">
                            <div class="hm-gallery-grid-img-cntlr">
                                <div class="hm-gallery-grid-img">
                                    <img
                                        src="assets/images/power-plant/power-plant-6.jpg" />
                                </div>
                            </div>
                            <div class="hm-gallery-grid-dsc">
                                <h5>Title 2023</h5>
